...
function vp_map_pins($tproperties) {
    ...
    foreach($tproperties as $property) {
        ...
        $pstr .= "'".str_replace("'","\'","<div class=\"vp_marker_content\">".vp_propertyimage($property->vebraid,0,"vp_pin_image")."<br /><em>".$property->address_custom."</em><br />".$property->property_type."</em><br /><span>&pound;".number_format($property->price,0,"",",")." ".$property->price_postfix."</span><br /><a href=\"".vp_propertyurl($property->agentref)."\">View details</a></div>")."'";
        $pstr .= "]\r\n";
    }
    $pstr .= "];\r\n";
